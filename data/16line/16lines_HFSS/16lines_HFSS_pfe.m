function [Y] = 16lines_HFSS_pfe(arg1,arg2,arg3)
% This function takes the coefficients from 16lines_HFSS_pfe and
...
% 
% Example 1: Y = 16lines_HFSS_pfe(f) returns
%            at the SINGLE frequency f.
% Example 2: Y_12 = 16lines_HFSS_pfe(1,2,f) returns
...
elseif nargin == 3
  ...
  Y = [];
  disp(' Incorrect Number Of Arguments to 16lines_HFSS_pfe ') 
end
