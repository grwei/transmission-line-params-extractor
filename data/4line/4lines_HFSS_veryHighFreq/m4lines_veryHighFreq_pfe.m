function [Y] = m4lines_veryHighFreq_pfe(arg1,arg2,arg3)
% This function takes the coefficients from m4lines_veryHighFreq_pfe and
...
% 
% Example 1: Y = m4lines_veryHighFreq_pfe(f) returns
%            at the SINGLE frequency f.
% Example 2: Y_12 = m4lines_veryHighFreq_pfe(1,2,f) returns
...
elseif nargin == 3
  ...
  Y = [];
  disp(' Incorrect Number Of Arguments to m4lines_veryHighFreq_pfe ') 
end
